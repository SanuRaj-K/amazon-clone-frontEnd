...
const AdminHeader = () => {
  ...
  return (
    <div className="bg-white p-4 shadow-md flex justify-around  ">
      {toggle ? (
        <img src={closeIcon} alt="" onClick={closeToggle}  className="w-[30px] h-[28px] cursor-pointer"/>
      ) : (
        <img src={hamburge} alt="" onClick={handleToggle} className=" h-[30px] w-[30px] cursor-pointer" />
      )}
